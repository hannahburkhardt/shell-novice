...
> 
> We can use the command `cut -d , -f 2 animals.txt | sort | uniq` to produce the unique species in `animals.txt`. In order to avoid having to remember and type out this series of commands every time, a scientist may choose to write a shell script instead.
>
